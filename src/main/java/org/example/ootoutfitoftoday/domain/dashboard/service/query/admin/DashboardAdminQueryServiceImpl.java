...
public class DashboardAdminQueryServiceImpl implements DashboardAdminQueryService {
    ...
    public AdminUserStatisticsResponse adminUserStatistics(LocalDate baseDate) {
        ...
        if (cache == null) throw new IllegalStateException("해당 캐시 이름이 등록되어 있지 않습니다: " + DashboardCacheNames.USER);
    ...
    public AdminClothesStatisticsResponse adminClothesStatistics() {
        ...
        if (cache == null) throw new IllegalStateException("의류 캐시가 등록되어 있지 않습니다: " + DashboardCacheNames.CLOTHES);
    ...
    public AdminSalePostStatisticsResponse adminSalePostStatistics(LocalDate baseDate) {
        ...
        if (cache == null) throw new IllegalStateException("해당 캐시 이름이 등록되어 있지 않습니다: " + DashboardCacheNames.SALE_POST);
    ...
    public AdminTopCategoryStatisticsResponse adminTopCategoryStatistics() {
        ...
        if (cache == null) throw new IllegalStateException("카테고리 캐시가 등록되어 있지 않습니다: " + DashboardCacheNames.CATEGORY);
