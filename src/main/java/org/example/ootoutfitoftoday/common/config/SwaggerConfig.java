    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info().title("OOT(Outfit of Today) | 디지털 옷장 관리 서비스 기반 의류 중고 거래 API")
                        .description("""
                                OOT(Outfit of Today) 백엔드 서비스의 공식 API 문서입니다.
                                
                                이 플랫폼은 **디지털 옷장 관리**를 핵심으로 제공하며, 이를 통해 **자주 안 입는 옷에 대해 기부 또는 판매를 추천**하여 옷의 활용도를 높입니다.
                                
                                **주요 특징:**
                                1. **회원 기반 서비스:** 옷장 관리, 중고 거래는 회원 전용 기능입니다.
                                2. **비회원 접근:** 공개 옷장 및 중고 거래 게시물, 기부처 조회는 비회원도 가능합니다.
